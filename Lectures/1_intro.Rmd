...
<center><img src="figs/datagrowth.png" width = "90%"></center>
...
<center><img src="figs/hype_cycle.png" width = "85%"></center>
...
--
  ...
  - e.g., why have countries stopped (or attenuated) currency manipulation?
...
--
  ...
  - e.g., trade has changed and therefore the exchange rate preferences of political actors have changed
  
--

  - Changing trade: global value chains now account for 70% of global trade (~50% in 1990s)
...
4. Acknowledge limitations of methods and results, and describe a superior empirical setting that would overcome these limitations.
...
- 4 problem sets (19 points each)
  
  - 2 extra credit points available each PSet
  
--

- 100 points: (14 x 2) + (19 x 4)
...
- Think of these as your readings/practice for each class. Do them!
...
--
  ...
  - ChatGPT: provide a link to your session if you have an account; otherwise, print the output as PDF
  - Microsoft Copilot: print the output as PDF
...
--
  ...
  2. Create a CampusWire account (PIN: )
